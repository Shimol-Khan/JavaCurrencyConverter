	...
	public void defaultValues() {
		...
		switch (currency) {	
			case "US Dollar":
				...
				this.exchangeValues.put("MYR", 4.22);
				this.exchangeValues.put("BDT", 85.13);
				break;
			case "Euro":
				...
				this.exchangeValues.put("MYR", 5.02);
				this.exchangeValues.put("BDT", 101.15);
				break;
			case "British Pound":
				...
				this.exchangeValues.put("MYR", 5.88);
				this.exchangeValues.put("BDT", 118.49);
				break;
			case "Swiss Franc":
				...
				this.exchangeValues.put("MYR", 4.67);
				this.exchangeValues.put("BDT", 94.01);
				break;
			case "Chinese Yuan Renminbi":
				...
				this.exchangeValues.put("MYR", 0.65);
				this.exchangeValues.put("BDT", 13.18);
				break;
			case "Japanese Yen":
				...
				this.exchangeValues.put("MYR", 0.039);
				this.exchangeValues.put("BDT", 0.78);
				break;
		}
	}
