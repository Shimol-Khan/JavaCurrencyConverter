...
public class AboutWindow extends JFrame {
	...
	private AboutWindow() {
		...
		// Label "author"
		JLabel lblAuthor = new JLabel("Shimol Khan");
		lblAuthor.setHorizontalAlignment(SwingConstants.CENTER);
		lblAuthor.setBounds(65, 122, 219, 33);

		// label with a clickable link
		JLabel lblLink = new JLabel("https://github.com/Shimol-Khan");
		...
		lblLink.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                try {
                    Desktop.getDesktop().browse(new URI("https://github.com/Shimol-Khan"));
                } catch (Exception ex) {
                	ex.printStackTrace();
                }
            }
		...
		// label "title"
		JLabel lblTitle = new JLabel("UPSI Currency Converter");
